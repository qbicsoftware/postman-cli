...
public class CommandLineVerification {
     ...
     * @throws IOException
     */
    public static PostmanCommandLineOptions verifyCommandLineParameters(String[] args) throws IOException {
        if (args.length == 0) {
        ...
        if ((commandLineParameters.ids == null || commandLineParameters.ids.isEmpty()) && commandLineParameters.filePath == null) {
            ...
            commandLineParameters.ids = CommandLineParser.readProvidedIdentifiers(commandLineParameters.filePath.toFile());
        }
